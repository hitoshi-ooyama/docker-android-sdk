...
RUN curl --location http://dl.google.com/android/android-sdk_r24.3.4-linux.tgz | tar -x -z -C /usr/local/src \
 && echo "y" |android update sdk --force --no-ui --all --filter tools,platform-tools,build-tools-22.0.0,android-22,android-8,android-17,android-16,build-tools-19.1.0,android-13,android-9,build-tools-23.0.2,android-23,extra-android-support,extra-android-m2repository,extra-google-m2repository
